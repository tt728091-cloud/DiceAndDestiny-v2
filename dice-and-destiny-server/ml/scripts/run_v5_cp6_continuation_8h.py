...
CAMPAIGN_ID = "v5-relational-cp6-continuation-cp193-20260808-8h"
SOURCE_CAMPAIGN_ID = "v5-relational-fresh-cp193-20260808-1h"
SOURCE_INTERVAL = 6
...
def campaign_config(ml_root: Path, server_root: Path) -> WinnerHealthCampaignConfig:
    ...
    return WinnerHealthCampaignConfig(
        ...
        observation_manifest=source_root / "observation-manifest-v5.json",
        entity_width=96,
        decision_width=432,
        entity_depth=1,
        decision_depth=2,
