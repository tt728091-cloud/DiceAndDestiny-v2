...
func _catalog_fixture() -> Dictionary:
	...
	return {
		...
		"abilities": abilities,
		"statuses": {
			"poison": {"name": "Poison", "polarity": "negative", "presentation": {"rules_text": "Roll per stack", "glyph": "☠"}, "triggers": [{"id": "poison_on_enter", "operations": [{"id": "poison_rolls", "type": "roll_dice", "outcomes": [{"faces": [1, 2, 3, 4], "operations": [{"type": "deal_damage", "amount": 1}]}, {"faces": [5, 6], "operations": [{"type": "remove_status_stack", "status_id": "poison", "stack_count": 1}]}]}]}]},
